...
Description:
Implemented driver for test 11.1.03_a05_02
'''
...
pkg_out = join(output_dir, 'src', 'build', 'default', 'libdefault_dir2.a')
...
on_compile(cjc(option='--import-path {} '.format(join(output_dir, "src", "build")) + 
