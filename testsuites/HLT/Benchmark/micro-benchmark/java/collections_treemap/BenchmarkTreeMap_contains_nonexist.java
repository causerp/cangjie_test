...
@Fork(1)
public class BenchmarkTreeMap_contains_nonexist {
    ...
    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_Int64_N16(Blackhole blackhole) {
        boolean flag = mapInt64_16.containsKey(-8L);
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_Int64_N256(Blackhole blackhole) {
        boolean flag = mapInt64_256.containsKey(-128L);
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_Int64_N2048(Blackhole blackhole) {
        boolean flag = mapInt64_2048.containsKey(-1024L);
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_Int64_N16384(Blackhole blackhole) {
    ...
    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_String_N16(Blackhole blackhole) {
        boolean flag = mapString_16.containsKey("-8");
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_String_N256(Blackhole blackhole) {
        boolean flag = mapString_256.containsKey("-128");
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_String_N2048(Blackhole blackhole) {
        boolean flag = mapString_2048.containsKey("-1024");
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeMap_contains_nonexist_String_N16384(Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkTreeMap_contains_nonexist.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
