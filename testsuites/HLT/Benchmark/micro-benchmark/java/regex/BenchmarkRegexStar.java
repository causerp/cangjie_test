...
@Fork(1)
public class BenchmarkRegexStar {
    ...
    public void setup() {
        ...
        String matchString1 = stringBlock(counts, stringSize, "zo", "X");
        Pattern regex = Pattern.compile(regexString);
        matcher = regex.matcher(matchString1);
    }

    @Benchmark
    public void BenchmarkRegexStar_MatchCnt() {
        while (matcher.find()) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkRegexStar.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
