...
@Fork(1)
public class BenchmarkRegexEscapCharterS {
    ...
    public void setup() {
        ...
        String matchString1 = stringBlock(counts, stringSize, " ", "X");
        Pattern regex = Pattern.compile(regexString);
        matcher = regex.matcher(matchString1);
    }

    @Benchmark
    public void BenchmarkRegexEscapCharterS_MatchCnt() {
        while (matcher.find()) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkRegexEscapCharterS.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
