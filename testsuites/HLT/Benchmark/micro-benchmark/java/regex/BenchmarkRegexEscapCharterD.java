...
@Fork(1)
public class BenchmarkRegexEscapCharterD {
    ...
    public void setup() {
        ...
        String matchString1 = stringBlock(counts, stringSize, "1", "X");
        Pattern regex = Pattern.compile(regexString);
        matcher = regex.matcher(matchString1);
    }

    @Benchmark
    public void BenchmarkRegexEscapCharterD_MatchCnt() {
        while (matcher.find()) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkRegexEscapCharterD.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
