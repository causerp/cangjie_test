...
@Fork(1)
public class BenchmarkRegexBrackets {
    ...
    public void setup() {
        ...
        String matchString1 = stringBlock(counts, stringSize, "xa", "z");
        Pattern regex = Pattern.compile(regexString);
        matcher = regex.matcher(matchString1);
    }

    @Benchmark
    public void BenchmarkRegexBrackets_MatchCnt() {
        while (matcher.find()) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkRegexBrackets.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
