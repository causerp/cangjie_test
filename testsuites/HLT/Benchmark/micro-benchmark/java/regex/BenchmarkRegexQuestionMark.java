...
@Fork(1)
public class BenchmarkRegexQuestionMark {
    ...
    public void setup() {
        ...
        String matchString1 = stringBlock(counts, stringSize, "zo", "f");
        Pattern regex = Pattern.compile(regexString);
        matcher = regex.matcher(matchString1);
    }

    @Benchmark
    public void BenchmarkRegexQuestionMark_MatchCnt() {
        while (matcher.find()) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkRegexQuestionMark.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
