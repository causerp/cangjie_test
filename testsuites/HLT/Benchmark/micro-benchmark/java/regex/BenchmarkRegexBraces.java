...
@Fork(1)
public class BenchmarkRegexBraces {
    ...
    public void setup() {
        ...
        String matchString1 = stringBlock(counts, stringSize, "yy", "z");
        Pattern regex = Pattern.compile(regexString);
        matcher = regex.matcher(matchString1);
    }

    @Benchmark
    public void BenchmarkRegexBraces_MatchCnt() {
        while (matcher.find()) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkRegexBraces.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
