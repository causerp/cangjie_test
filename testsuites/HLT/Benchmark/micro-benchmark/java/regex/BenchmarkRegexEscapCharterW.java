...
@Fork(1)
public class BenchmarkRegexEscapCharterW {
    ...
    public void setup() {
        ...
        String matchString1 = stringBlock(counts, stringSize, "_", "X");
        Pattern regex = Pattern.compile(regexString);
        matcher = regex.matcher(matchString1);
    }

    @Benchmark
    public void BenchmarkRegexEscapCharterW_MatchCnt() {
        while (matcher.find()) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkRegexEscapCharterW.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
