...
@Fork(1)
public class BenchmarkTreeSet_contains {
    ...
    @Benchmark
    public void BenchmarkTreeSet_contains_Int64_N16(Blackhole blackhole) {
        boolean flag = treeSet_Long_16.contains(8L);
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeSet_contains_Int64_N256(Blackhole blackhole) {
        boolean flag = treeSet_Long_256.contains(128L);
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeSet_contains_Int64_N2048(Blackhole blackhole) {
        boolean flag = treeSet_Long_2048.contains(1024L);
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeSet_contains_Int64_N16384(Blackhole blackhole) {
        boolean flag = treeSet_Long_16384.contains(8192L);
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeSet_contains_String_N16(Blackhole blackhole) {
        boolean flag = treeSet_String_16.contains("8");
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeSet_contains_String_N256(Blackhole blackhole) {
        boolean flag = treeSet_String_256.contains("128");
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeSet_contains_String_N2048(Blackhole blackhole) {
        boolean flag = treeSet_String_2048.contains("1024");
        blackhole.consume(flag);
    }

    @Benchmark
    public void BenchmarkTreeSet_contains_String_N16384(Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkTreeSet_contains.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
