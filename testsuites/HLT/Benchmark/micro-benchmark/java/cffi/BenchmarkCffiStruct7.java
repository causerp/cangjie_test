...
public class BenchmarkCffiStruct7 {
    public static int reps = 100000;

    static {
        System.loadLibrary("BenchmarkCffiStruct7");
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("BenchmarkCffiStruct7: " + String.format("%.2f", perTime) + " ns/op");
    }

    public static native int testFunc(Data64 param1, Data64 param2, Data64 param3, Data64 param4, Data64 param5,
            Data64 param6, Data64 param7, Data64 param8);
}
