...
@Fork(1)
public class BenchmarkWriteArrayInOrderD1 {
    static int num32 = 32;
    ...
    @Benchmark
    public void BenchmarkWriteArrayInOrderD1_N32() {
    ...
    @Benchmark
    public void BenchmarkWriteArrayInOrderD1_N256() {
    ...
    @Benchmark
    public void BenchmarkWriteArrayInOrderD1_N2048() {
    ...
    @Benchmark
    public void BenchmarkWriteArrayInOrderD1_N16384() {
    ...
    @Benchmark
    public void BenchmarkWriteArrayInOrderD1_N131072() {
    ...
    @Benchmark
    public void BenchmarkWriteArrayInOrderD1_N1048576() {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkWriteArrayInOrderD1.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
