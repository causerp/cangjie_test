...
public class BenchmarkJsonWriteInt64 {
    ...
    @Benchmark
    public void BenchmarkJsonWriteInt64_G10() throws IOException{
        for (int i = 0; i < 10; i++) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(json.BenchmarkJsonWriteInt64.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
