...
public class BenchmarkJsonReadInt64 {
    ...
    @Benchmark
    public void BenchmarkJsonReadInt64_G10(Blackhole blackhole) throws IOException{
        Long value = 0L;
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(json.BenchmarkJsonReadInt64.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
