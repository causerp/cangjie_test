...
@Fork(1)
public class BenchmarkStringNotEqual {
    ...
    public void BenchmarkStringNotEqual_N1_Equal(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringNotEqual_N1_notEqual(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringNotEqual_N1k_Equal(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringNotEqual_N1k_notEqual(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringNotEqual_N1m_Equal(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringNotEqual_N1m_notEqual(Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkStringNotEqual.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
