...
@Fork(1)
public class BenchmarkStringLessEqual {
    ...
    public void BenchmarkStringLessEqual_N1_Less(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1_notLess(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1_Equal(Blackhole blackhole) {
        int flag = str_1.compareTo(str_1_equal);
        blackhole.consume(flag);
    }
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1k_Less(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1k_notLess(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1k_Equal(Blackhole blackhole) {
        int flag = str_1k.compareTo(str_1k_equal);
        blackhole.consume(flag);
    }
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1m_Less(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1m_notLess(Blackhole blackhole) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Measurement(iterations = 1)
    public void BenchmarkStringLessEqual_N1m_Equal(Blackhole blackhole) {
        int flag = str_1m.compareTo(str_1m_equal);
        blackhole.consume(flag);
    }

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkStringLessEqual.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
