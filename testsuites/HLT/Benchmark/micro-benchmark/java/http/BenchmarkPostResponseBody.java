...
@Fork(1)
public class BenchmarkPostResponseBody {
    ...
    public void startServerAndClient() throws IOException {
        ...
        httpServer.createContext("/dd", new BenchmarkPostResponseBody.TestHandler());
        httpServer.start();
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkPostResponseBody.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
