...
@Fork(1)
public class BenchmarkPostRequestBody {
    ...
    public void startServerAndClient() throws IOException {
        ...
        httpServer.createContext("/dd", new BenchmarkPostRequestBody.TestHandler());
        httpServer.start();
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkPostRequestBody.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
