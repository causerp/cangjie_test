...
@inline(never)
func BenchmarkContainsInHashset(x: Int) -> TimeInterval {
...
for num in counts{
    print("BenchmarkContainsInHashset_Int64_\(num): \(BenchmarkContainsInHashset(x: num).formatted(decimalPoint:2)) ns/op")
}