...
@inline(never)
func BenchmarkHashMapRemove(x: Int) -> TimeInterval {
...
for num in counts{
    print("BenchmarkHashMapRemove_\(num): \(BenchmarkHashMapRemove(x: num).formatted(decimalPoint:2)) ns/op")
}