...
@inline(never)
func BenchmarkHashMapGet_Operator(x: Int) -> TimeInterval {
...
for num in counts{
    print("BenchmarkHashMapGet_Operator_Int64_\(num): \(BenchmarkHashMapGet_Operator(x: num).formatted(decimalPoint:2)) ns/op")
}