...
@inline(never)
func BenchmarkHashMapPut_Operator(x: Int) -> TimeInterval {
...
for num in counts{
    print("BenchmarkHashMapPut_Operator_Int64_\(num): \(BenchmarkHashMapPut_Operator(x: num).formatted(decimalPoint:2)) ns/op")
}