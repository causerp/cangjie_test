...
double CangjieFunc(int a0, double a1, int a2, double a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10,
                   int a11);
...
int main(int argc, char* argv[])
{
    ...
    double res = CangjieFunc(1, 2.45, 2, 3.58, 4, 5, 6, 7, 8, 9, 10, 11);
    printf("res is: %.2f\n", res);
    while (index1 != 0) {
